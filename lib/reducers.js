...
import type { Action, CardsObj, Card, OtherState, Planet, State, Zone, Zones } from './types';
...
function getStrength(cards: Card[]) {
...
function damageCards(cards: Card[], damage: number): Card[] {
