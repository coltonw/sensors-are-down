...
function checkForVictory({ state, actions }) {
  // TODO: Goto readme for details
  return { state, actions };
}

function getStrength(cards) {
  return cards.reduce((card, curr) => ({
...
function damageCards(cards, damage) {
  return cards.reduce((card, { damagedCards, damageLeft }) => {
    if (damageLeft > card.strength) {
